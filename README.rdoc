...
traditional_chinese?:: Return true if the string contains traditional Chinese characters
simplified_chinese?:: Return true if the string contains simplified Chinese characters

It is important to understand that this _requires_ long sections of text to work reliably, since a single character or even several characters may be valid Japanese, traditional Chinese and simplified Chinese simultaneously.  Details: http://unicode.org/faq/han_cjk.html#4
...
* Details: http://www.unicode.org/reports/tr38/
* Download: http://unicode.org/Public/UNIDATA/Unihan.zip
...
Copyright (c) 2012 Jani Patokallio. See LICENSE.txt for
further details.
